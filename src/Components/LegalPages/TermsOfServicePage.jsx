...
const termsSections = [
  {
    ...
    content: (
      <>
        <p>
          By accessing or using the AXO FAM website, shop pages, or related
    ...
    content: (
      <>
        <p>
          ...
          use the site in a manner that could harm AXO FAM, its users, or its
          operations.
        </p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>
          Products, collections, content, and features shown on the AXO FAM
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Unless otherwise stated, all AXO FAM branding, characters, artwork,
          product designs, visuals, copy, videos, audio, games, and other site
          content are owned by or licensed to AXO FAM. These materials may not
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          AXO FAM is presented as a family-friendly brand. Parents and guardians
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          To the fullest extent permitted by law, AXO FAM and its operators will
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          We may revise these Terms of Service from time to time as AXO FAM
...
const TermsOfServicePage = () => {
  return (
    <LegalPageLayout
      eyebrow="AXO FAM legal"
      title="Terms of Service"
      summary="These Terms of Service govern access to the AXO FAM website, its content, shop pages, and related digital experiences. They are designed to keep the platform clear, safe, and respectful for all visitors."
