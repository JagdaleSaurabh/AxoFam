...
const privacySections = [
  {
    ...
    content: (
      <>
        <p>
          We may collect basic information that helps us operate the AXO FAM
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          We use collected information to keep AXO FAM useful, safe, and easy to
          improve.
        </p>
        <ul>
          <li>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          AXO FAM is designed as a family-friendly brand. We encourage parents
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          We may update this Privacy Policy from time to time as AXO FAM grows
...
const PrivacyPolicyPage = () => {
  return (
    <LegalPageLayout
      ...
      summary="This Privacy Policy explains how AXO FAM may collect, use, and protect information when you browse our website, explore our shop pages, sign up for updates, or interact with our digital experiences."
