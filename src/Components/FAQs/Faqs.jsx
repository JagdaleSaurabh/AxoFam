...
const faqItems = [
  {
    category: "Universe",
    question: "What is AXOFAM?",
    answer:
      "AXOFAM is a playful kids universe built around toys, clothing, storybooks, games, songs, videos, and fun everyday products.",
  },
  {
    category: "Products",
    question: "What kind of products will AXOFAM offer?",
    answer:
      "AXOFAM will offer plush toys, story books, water toys, school essentials, kids clothing, hoodies, and accessories.",
  },
  {
    category: "Media",
    question: "Will AXOFAM have games and videos too?",
    answer:
      "Yes. AXOFAM is not limited to physical products. It also includes games, songs, audio content, and kid-friendly videos.",
  },
  {
    category: "Launches",
  ...
  {
    category: "Updates",
    question: "How can I stay updated on new AXOFAM launches?",
    answer: "You can follow AXOFAM on Instagram and Twitter for updates.",
  },
];
        ...
        {/* <header className="faqs-page__hero" data-reveal>
          <div className="faqs-page__hero-copy">
            ...
            <p className="faqs-page__lead">
              ...
              to know about the AXOFAM world, all in one brighter and easier
              place.
            </p>
          </div>
        </header> */}
